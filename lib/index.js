...
let subscriptionApi
setImmediate(() => {
    subscriptionApi = new paddleIntegration.Api({
 ...
 */
module.exports.createActivePaddleSubscription = async function createActivePaddleSubscription({ serverPort = 9876, vendorId, productId }) {
...
//     console.log('cancelling subsc', JSON.stringify(subscription, null, 2))
